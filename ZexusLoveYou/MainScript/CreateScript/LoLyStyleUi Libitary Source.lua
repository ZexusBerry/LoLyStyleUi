...
local mainMenu = UI:CreateMenu(game.Players.LocalPlayer.PlayerGui, "Main Menu", 300, 400)

-- Создаем кнопки
local button1 = UI:CreateButton(mainMenu, "Button 1", function()
    print("Button 1 clicked!")
end)

local button2 = UI:CreateButton(mainMenu, "Button 2", function()
    print("Button 2 clicked!")
end)
button2.Position = UDim2.new(0.5, 0, 0.4, 0)

-- Создаем метку
local label = UI:CreateLabel(mainMenu, "Hello, World!")
label.Position = UDim2.new(0.5, 0, 0.6, 0)

-- Создаем выпадающий список
local dropDownOptions = {"Option 1", "Option 2", "Option 3"}
local dropDown = UI:CreateDropDown(mainMenu, dropDownOptions, function(index, option)
    print("Selected option:", option)
end)
dropDown.Position = UDim2.new(0.5, 0, 0.8, 0)

-- Создаем вкладки
local tabs = {
    {name = "Tab 1", onSelected = function() print("Tab 1 selected!") end},
    {name = "Tab 2", onSelected = function() print("Tab 2 selected!") end},
    {name = "Tab 3", onSelected = function() print("Tab 3 selected!") end}
}
local tabContainer = UI:CreateTabs(mainMenu, tabs)
